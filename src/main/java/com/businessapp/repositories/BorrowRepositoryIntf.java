 ...
 *
 */
public interface BorrowRepositoryIntf extends RepositoryIntf<Borrow>{
	/**
	 * Create a new Borrow entity that is *not* yet managed in the repository.
	 * A new entity is added to the repository using the update() method.
	 * 
	 * @return new Borrow entity instance that is not yet managed in the repository.
	 */
	 ...
	 */
	@Override
	public Borrow update( Borrow c, boolean insert );
